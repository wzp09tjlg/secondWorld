...
public class TodoProvider extends ContentProvider {
    ...
    //得到todos表中的所有记录 （最后的一个段是指的表的名字）在每次修改表的名字 之后 要么卸载重装 ，要么升级数据库版本，在新建一张表
    public static String TODOS = "vnd.android.cursor.dir/vnd.example.todosTemp";
    //得到一个表信息
    public static String TODO = "vnd.android.cursor.item/vnd.example.todosTemp";
