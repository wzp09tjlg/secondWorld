...
//        view.setPadding(0, 0, 0, 0);
    ...
    private void setModeStyle() {
        if (mRootView != null) {
          /*  mCloseView.setImageResource(ModeManager.drawable_icon_dialog_common_close);
            mRootView.setBackgroundDrawable(ModeManager.getDrawable(mContext, ModeManager.drawable_dialog_common_bg));
            mTitleView.setTextColor(ModeManager.getColor(mRootView.getContext(),
                    ModeManager.color_dialog_common_title_text));*/
        }
    }
