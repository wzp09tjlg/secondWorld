 ...
 */
public class TaskTwoActvity extends AppCompatActivity {
    private static final String TAG = TaskTwoActvity.class.getSimpleName();
    ...
    private void initView(){
        btnBase = (Button)findViewById(R.id.btn_task_base);
        btnBase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TaskTwoActvity.this,LuanchActivity.class);
