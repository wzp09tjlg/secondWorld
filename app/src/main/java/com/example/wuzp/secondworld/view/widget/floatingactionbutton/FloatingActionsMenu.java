package com.example.wuzp.secondworld.view.widget.floatingactionbutton;
...
public class FloatingActionsMenu extends ViewGroup {
  ...
  private static final float EXPANDED_PLUS_ROTATION = 90f + 90f;
  ...
  private void init(Context context, AttributeSet attributeSet) {
    ...
    if (mLabelsStyle != 0 && expandsHorizontally()) {
      throw new IllegalStateException("MyAction labels in horizontal expand orientation is not supported.");
    }
  ...
  private void createAddButton(Context context) {
    mAddButton = new AddFloatingActionButton(context) {
      ...
      Drawable getIconDrawable() {
        final RotatingDrawable rotatingDrawable = new RotatingDrawable(getResources().getDrawable(R.drawable.icon_spread_floating_button));
  ...
  protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    case EXPAND_RIGHT:
      ...
      for (int i = mButtonsCount - 1; i >= 0; i--) {
        ...
        child.setRotation(mExpanded? 360f: 0f);
  ...
  private class LayoutParams extends ViewGroup.LayoutParams {
    ...
    private ObjectAnimator mRotationIn=new ObjectAnimator();
    private ObjectAnimator mRotationInBack=new ObjectAnimator();
    private ObjectAnimator mRotationOut=new ObjectAnimator();
    ...
    public LayoutParams(ViewGroup.LayoutParams source) {
      ...
      mRotationIn.setInterpolator(sExpandInterpolator);
      mRotationOut.setInterpolator(sExpandInterpolator);
      mRotationInBack.setInterpolator(sExpandInterpolator);
      ...
      mRotationIn.setProperty(View.ROTATION);
      mRotationIn.setFloatValues(0f,360f);

      mRotationOut.setProperty(View.ROTATION);
      mRotationOut.setFloatValues(360f,0f);
    ...
    public void setAnimationsTarget(View view) {
      ...
      mRotationIn.setTarget(view);
      mRotationInBack.setTarget(view);
      mRotationOut.setTarget(view);
      ...
      if (!animationsSetToPlay) {
        ...
        mCollapseAnimation.play(mRotationOut);
        mCollapseAnimation.play(mCollapseDir);
        mExpandAnimation.play(mRotationIn);
