...
public class TaskOneActivity extends AppCompatActivity {
    ...
    private void initView(){
        btnOneOne = (Button)findViewById(R.id.btn_task_one_one);
        btnOneOne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TaskOneActivity.this,TaskOneOneActivity.class);
