package com.example.wuzp.secondworld.view.widget.Besier;
...
public class BesierTT extends View {
    ...
    public BesierTT(Context context) {
        this(context, null);

    }

    public BesierTT(Context context, AttributeSet attrs) {
        super(context, attrs);
